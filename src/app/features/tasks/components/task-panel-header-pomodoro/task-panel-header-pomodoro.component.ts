...
@Component({
  selector: 'app-task-panel-header-pomodoro',
  templateUrl: './task-panel-header-pomodoro.component.html',
  styleUrl: './task-panel-header-pomodoro.component.scss',
  imports: [MatIconModule, MatTooltipModule, ClickOutsideDirective],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class TaskPanelHeaderPomodoroComponent {
